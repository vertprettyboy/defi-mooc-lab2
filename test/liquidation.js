...
describe("Liquidation Question 3", function () {
  it("Test real-world liquidation", async function () {
    await network.provider.request({
      ...
      params: [{
        forking: {
          ...
          // ลองเปลี่ยนเป็น 11946808 ถ้า 11946807 ยังขึ้น Error 23
          blockNumber: 11946808, 
        }
      }]
    });
    ...
    if (liquidationEvents.length > 0) {
        console.log("Match Expected Liquidation Event!");
    }
  });
});
